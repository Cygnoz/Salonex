    ...
    <div>
      <div className="flex mb-3 gap-5">
        ...
        <div className="flex justify-center items-center">
          <h4 className="font-bold text-base text-[#0B1320]">              {page === "edit" ? "Edit Bill " : "Create New Bill"}
          </h4>
        </div>
      </div>
          ...
          <div className=" grid grid-cols-3 gap-4 ">
            <div>
              ...
              {openDropdownIndex === "supplier" && (
                <div
                  ref={dropdownRef}
                  className="absolute z-10 bg-white  shadow  rounded-[15px] mt-1 p-2 w-[20%] space-y-1 max-h-72 overflow-y-auto  hide-scrollbar"
                >
                  <SearchBar
      ...
      >
        <div className="flex gap-2 ml-auto">
          ...
          <Button variant="primary" onClick={handleSave}>Save & Send</Button>
        </div>
      </div>
    </div>
  );
