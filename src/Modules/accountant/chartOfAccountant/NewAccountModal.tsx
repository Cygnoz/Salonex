import bgImg1 from "../../../assets/images/Wallet-bro 1.png"
...
function NewAccountModal({ page, accountData, fetchAllAccounts }: Props) {
  ...
  return (
    <div className="">
      ...
      <Modal open={isModalOpen} onClose={closeModal} className="w-[50%]  text-start p-8 bg-[#FAF7F2]">
        <div
        ...
        >
          <div className="relative flex-1">
            <p className="text-[#383c42] font-bold text-base">
              {
                page === "Edit" ? "Edit Account" : "Add Account"
              }
            </p>
          ...
          <div className="flex ml-auto">
            <img src={bgImg2} alt="" className="h-[140px] " />
            ...
            <div className="flex flex-col">
              ...
              <div className="relative w-full">
                ...
                >
                  ...
                  {chartOfAcc.map((item: any, index: any) => (
                    <optgroup className="text-maroon" key={index} label={item.head}>
                      {item.subhead.map((subitem: any, subindex: any) => (
