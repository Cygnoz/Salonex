                    ...
                    {/* <div className="col-span-1 space-y-2">
                      ...
                      <div className="relative w-full">
                        <select
                          ...
                          className={`appearance-none w-full h-9 bg-white border border-inputBorder text-sm pl-2 pr-8 rounded-full leading-tight focus:outline-none focus:bg-white focus:border-gray-500 cursor-pointer ${expenseData?.expense[0]?.expenseAccount
                            ? "text-gray-700"
                            : "text-zinc-400"
                            }`}
                        >
                ...
                <div className="col-span-1 space-y-2">
                  ...
                  <div className="relative w-full">
                    <select
                      ...
                      onChange={handleChange}
                      className={`appearance-none w-full h-9 bg-white border border-inputBorder text-sm pl-2 pr-8 rounded-full leading-tight focus:outline-none focus:bg-white focus:border-gray-500 cursor-pointer ${expenseData.gstTreatment === ""
                        ? "text-zinc-400"
                        : "text-zinc-700"
                        }`}
                    >
              ...
              <div className="col-span-1 space-y-2">
                ...
                <div className="relative w-full">
                  {/* <select
                    ...
                    onChange={(e) => {
                      const selectedValue = e.target.value;
                      const selectedAccount: any = accountData?.paidThroughAccountId?.find(
                        (account: any) => account.accountName === selectedValue
                      );
                      setExpenseData({
                        ...expenseData,
                        paidThrough: selectedValue,
                        paidThroughAccountId: selectedAccount?._id || "",
                      });
                    }}
                    className="appearance-none w-full h-9 text-zinc-700 bg-white border border-inputBorder text-sm pl-2 pr-8 rounded-full leading-tight focus:outline-none focus:bg-white focus:border-gray-500 cursor-pointer"
                  >
