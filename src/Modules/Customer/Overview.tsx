  ...
  return (
    ...
    <div className="p-4 grid grid-cols-12 gap-6 grid-rows-2 h-[90vh] hide-scrollbar overflow-y-scroll">
      <div className="col-span-3">
        <div className=" ">
          {/* First Card */}
          <div className="w-[283px] h-[333px]  bg-white rounded-2xl shadow-lg p-6 space-y-4 text-[#303F58]">
          ...
          {/* Second Card */}
          <div className="h-[170px] w-[283px] mt-4 bg-white rounded-xl shadow-lg p-5">
      ...
      <div className="col-span-6">
        <div className="space-y-6  ">
          ...
          <div className="bg-white w-[641px] h-[587px] rounded-xl shadow-lg p-6">
            <h2 className="text-lg font-bold text-[#303F58] mb-4">Upcoming Appointment</h2>
            <div className="flex items-center justify-between  w-[597px] h-[107px]  bg-pink-100 rounded-lg p-4">
              {/* Date Section */}
      ...
      <div className="col-span-3">
        ...
        <div className="relative z-10 mb-4">
          <div className="h-[170px] w-[305px] bg-gradient-to-b from-[#D86490] to-[#9C5378] rounded-2xl p-4 flex flex-col justify-between shadow-md">
