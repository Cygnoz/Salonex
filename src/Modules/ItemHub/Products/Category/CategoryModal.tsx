  ...
  return (
    ...
    <div className='bg-[#F8F4F4] p-4 rounded-xl'>
        ...
        <img src={bg} className="w-8" alt="Back to Home Icon" />
         ...
         <h1 className="text-xs font-medium text-deepStateBlue">Organize and control product or service categories efficiently</h1>
         </div>
         </div>
    ...
    <Modal open={isModalOpen.addForm} onClose={() => handleModalToggle()} className="w-[35%]">
        <CategoryAddModal  onClose={() => handleModalToggle()} />
      </Modal>
    </>
  )
}
