            ...
            <div className="grid grid-cols-12 gap-4 bg-[#FFFFFF]">
                ...
                <div className="flex gap-4 my-8 items-center">
                    <div className="bg-[#FFFFFF] w-9 h-8 rounded-lg p-2 border border-[#E3E3E3]">
                        <PhoneIcon size={14} color="#2C3E50"/>
                    </div>
                    <div>
                        <p className="text-[#303F58] text-xs font-bold">Your Details</p>
                        <p className="text-[#67707E] text-xs font-medium">Mobile/Card Number Input</p>
                    </div>
                </div>
                <div className="flex gap-4 mb-8 items-center">
                    <div className="bg-[#FFFFFF] w-9 h-8 rounded-lg p-2 border border-[#E3E3E3]">
                        <Scissors size={14} color="#2C3E50"/>
                    </div>
                    <div>
                        <p className="text-[#303F58] text-xs font-bold">Service Selection</p>
                        <p className="text-[#67707E] text-xs font-medium">Select Services you want</p>
                    </div>
                </div>
                <div className="flex gap-4 mb-8 items-center">
                    <div className="bg-[#FFFFFF] w-9 h-8 rounded-lg p-2 border border-[#E3E3E3]">
                        <CalendarCheck width={14} height={14} color="#2C3E50"/>
                    </div>
                    <div>
                        <p className="text-[#303F58] text-xs font-bold">Date & Time Selection</p>
                        <p className="text-[#67707E] text-xs font-medium">Choose Date & Time</p>
                    </div>
                </div>
                <div className="flex gap-4 mb-8 items-center">
                    <div className="bg-[#FFFFFF] w-9 h-8 rounded-lg p-2 border border-[#E3E3E3]">
                    ...
                    <div>
                        <p className="text-[#303F58] text-xs font-bold">Staff Selection</p>
                        <p className="text-[#67707E] text-xs font-medium">Choose Your Stylist</p>
                    </div>
                </div>
                <div className="flex gap-4 mb-8 items-center">
                    <div className="bg-[#FFFFFF] w-9 h-8 rounded-lg p-2 border border-[#E3E3E3]">
                        <TickIcon size={14}color="#2C3E50" />
                    </div>
                    <div>
                        <p className="text-[#303F58] text-xs font-bold">Confirmation</p>
                        <p className="text-[#67707E] text-xs font-medium">Review & Confirm</p>
                    </div>
                </div>
                <div>
              ...
              `}
                   ...
                   <div className="bg-[#F7F9FC] rounded-lg px-5 py-4 w-[620px]">
                    ...
                    <div className="flex gap-4 justify-center mt-10 mb-6 items-center">
                        <Button variant="secondary" className="rounded-xl w-36 h-6 flex justify-center items-center">Back</Button>
                        <Button variant="primary" className="rounded-xl w-36 h-9 py-2 px-3 flex justify-center items-center">Next</Button>

                    </div>
                    <div className="flex gap-4 justify-center">
                        <div className="bg-[#D9D9D9] w-10 h-1 rounded-3xl"></div>
                        <div className="bg-[#D9D9D9] w-10 h-1 rounded-3xl"></div>
                        <div className="bg-[#D9D9D9] w-10 h-1 rounded-3xl"></div>
                        <div className="bg-[#D9D9D9] w-10 h-1 rounded-3xl"></div>
                        <div className="bg-[#D9D9D9] w-10 h-1 rounded-3xl"></div>
